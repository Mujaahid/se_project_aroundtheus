...
const toggleButtonState = (formElement, buttonElement) => {
    ...
    // Check if any input has a value that doesn't meet validity criteria
...
//   Close modal on backgraound



document.addEventListener('click', (e) => {
    // Check if the click happened on an element with the class 'popup' (i.e., the background)
